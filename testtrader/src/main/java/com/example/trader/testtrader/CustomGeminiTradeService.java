...
public class CustomGeminiTradeService extends GeminiTradeServiceRaw implements TradeService {

    private static final OpenOrders noOpenOrders = new OpenOrders(new ArrayList<LimitOrder>());

    public CustomGeminiTradeService(Exchange exchange) {
    ...
    public GeminiOrderStatusResponse customPlaceLimitOrder(LimitOrder limitOrder) throws IOException {
...
//        return String.valueOf(newOrder.getId());
    ...
    public TradeHistoryParams createTradeHistoryParams() {
        return new GeminiTradeService.GeminiTradeHistoryParams(CurrencyPair.BTC_USD, 500, new Date(0));
    }
